...
module.exports = {
        ...
        try {
            ...
            if (status && status !== "all") {
                if (!ALLOWED_STATUS.includes(status)) {
                    return res
                        .status(400)
                        .json({ message: "status không hợp lệ." });
                }
            ...
            return res
                .status(500)
                .json({ message: "Lỗi server.", error: e.message });
        }
    },
    ...
    async createFeedback(req, res) {
        try {
            ...
            if (typeof content !== "string" || !content.trim()) {
                return res
                    .status(400)
                    .json({ message: "content là bắt buộc." });
            }
    ...
    async updateFeedback(req, res) {
        try {
            ...
            if (!isValidObjectId(feedbackId)) {
                return res
                    .status(400)
                    .json({ message: "feedbackId không hợp lệ." });
            }
            ...
            if (!fb)
                return res
                    .status(404)
                    .json({ message: "Không tìm thấy feedback." });
            ...
            if (isAdmin(req)) {
                ...
                if (!status)
                    return res
                        .status(400)
                        .json({ message: "status là bắt buộc." });
                if (!ALLOWED_STATUS.includes(status)) {
                    return res
                        .status(400)
                        .json({ message: "status không hợp lệ." });
            ...
            if (String(fb.createdBy) !== String(userId)) {
                return res
                    .status(403)
                    .json({ message: "Bạn không có quyền sửa feedback này." });
            }
            ...
            if (fb.status === "resolved" || fb.status === "closed") {
                return res
                    ...
                    .json({
                        message:
                            "Không thể sửa khi feedback đã resolved/closed.",
                    });
            }
            ...
            if (req.body?.title != null) {
                if (
                    ...
                    return res
                        .status(400)
                        .json({ message: "title không hợp lệ." });
                }
            ...
            if (req.body?.reason != null) {
                if (
                    ...
                    return res
                        .status(400)
                        .json({ message: "reason không hợp lệ." });
                }
            ...
            if (req.body?.content != null) {
                if (
                    ...
                    return res
                        .status(400)
                        .json({ message: "content không hợp lệ." });
                }
            ...
            if (req.body?.status != null) {
                return res
                    .status(403)
                    .json({ message: "Bạn không có quyền chỉnh status." });
            }
            ...
            if (!isAdmin(req)) {
                if (String(fb.createdBy) !== String(userId)) {
                    return res
                        .status(403)
                        .json({
                            message: "Bạn không có quyền xoá feedback này.",
                        });
                }
                if (fb.status === "resolved" || fb.status === "closed") {
                    return res
                        ...
                        .json({
                            message:
                                "Không thể xoá khi feedback đã resolved/closed.",
                        });
                }
            }
    ...
    async getFormLink(req, res) {
        try {
            const formLink = await FormLink.findOne({ name: "form" }).lean();
            if (!formLink) {
                return res
                    .status(404)
                    .json({ message: "Không tìm thấy link form feedback." });
            }
            return res.json({
                message: "Lấy link form feedback thành công.",
                formLink: formLink.url,
            });
        } catch (e) {
            return res
                .status(500)
